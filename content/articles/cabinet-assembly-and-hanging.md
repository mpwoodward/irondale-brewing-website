Title: Cabinet Assembly and Hanging
Date: 2023-04-11 16:03
Author: mpwoodward
Category: Brewing Space, Homebrewing
Slug: cabinet-assembly-and-hanging
Status: published
...
Hanging the top cabinets proved to be the semi-tricky part since we had to plan pretty carefully and do a lot of math to make sure we were leaving exactly the right amount of space for the 30" range hood, and ideally get the upper cabinets the line up with the lower cabinets.

<!-- /wp:paragraph -->

<!-- wp:paragraph -->

Yet another thing I'd never done before executed pretty well in the end.

<!-- /wp:paragraph -->

<!-- wp:paragraph -->

Once all the doors and drawers are in, I think tiling the backsplash is next!
